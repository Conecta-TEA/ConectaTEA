...
const telaOTP = document.getElementById('telaOTP');
const formSolicitarOTP = document.getElementById('formSolicitarOTP');
const formVerificarOTP = document.getElementById('formVerificarOTP');
const emailLogin = document.getElementById('emailLogin');
const codigoOTP = document.getElementById('codigoOTP');
const emailExibicao = document.getElementById('emailExibicao');
